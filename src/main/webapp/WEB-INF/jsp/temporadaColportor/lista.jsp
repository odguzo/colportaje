...
<html>
    ...
    <body>
        ...
        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/temporadaColportor' />">
            ...
            <p class="well">
                <a class="btn btn-primary" href="<s:url value='/temporadaColportor/nueva'/>"><i class="icon-user icon-white"></i> <s:message code='temporadaColportor.nueva.label' /></a>
                ...
                <tbody>
                    <c:forEach items="${temporadaColportores}" var="temporadacolportor" varStatus="status">
                        <tr class="${status.index % 2 == 0 ? 'even' : 'odd'}">
                            <td><a href="<c:url value='/temporadaColportor/ver/${temporadacolportor.id}' />">${temporadacolportor.fecha}</a></td>
                            <td>${temporadacolportor.status}</td>
                            <td>${temporadacolportor.objetivo}</td>
                            <td>${temporadacolportor.observaciones}</td>
                            <td>${temporadacolportor.union.getNombre()}</td>

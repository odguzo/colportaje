    ...
    <body>
        ...
        <div id="ver-ciudad" class="content scaffold-list" role="main">
            ...
            <p class="well">
                ...
                <a class="btn btn-primary" href="<s:url value='../nueva'/>"><i class="icon-user icon-white"></i> <s:message code='ciudad.nueva.label' /></a>
            </p>
            ...
            <form:form commandName="ciudad" action="${eliminaUrl}" >
                ...
                <p class="well">
                    <a href="<c:url value='/ciudad/edita/${ciudad.id}' />" class="btn btn-primary"><i class="icon-edit icon-white"></i> <s:message code="editar.button" /></a>
                <form:hidden path="id" />

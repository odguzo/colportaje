...
<html>
    ...
    <body>
        ...
        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/temporada' />">
            ...
            <p class="well">
                <a class="btn btn-primary" href="<s:url value='/temporada/nueva'/>"><i class="icon-user icon-white"></i> <s:message code='temporada.nueva.label' /></a>
                ...
                <tbody>
                    <c:forEach items="${temporadas}" var="temporada" varStatus="status">
                        <tr class="${status.index % 2 == 0 ? 'even' : 'odd'}">
                            <td><a href="<c:url value='/temporada/ver/${temporada.id}' />">${temporada.nombre}</a></td>

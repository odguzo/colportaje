...
<html>
    ...
    <body>
        ...
        <form name="filtraLista" class="form-search" method="post" action="<c:url value='/admin/asociacion' />">
            ...
            <p class="well">
                <a class="btn btn-primary" href="<s:url value='/admin/asociacion/nueva'/>"><i class="icon-user icon-white"></i> <s:message code='asociacion.nueva.label' /></a>
